...
| `teste-estagiario-manual.js` | O Estagiário sem IA: o botão **Preencher manual** abre a mesma prévia editável com os campos em branco (e some na Agenda Mensal, que não passa por IA); nenhuma chamada de IA sai nesse caminho; o plano impresso entra no histórico do aparelho e só então o **Puxar anterior** aparece; puxar com a prévia vazia preenche tudo e, com algo já escrito, responder "Cancelar" **completa** em vez de sobrescrever; o Anexo III - PAEE puxa o que já está salvo no perfil do estudante; e o fluxo com IA continua chegando na revisão com o rascunho preenchido. |
