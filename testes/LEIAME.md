...
| `teste-resgate.js` | A Central de Resgate sobre o estrago real da transição cancelada: acha a cópia do aparelho e o slot de backup que sobreviveu **sem** o índice (apagado no mesmo laço), avisa do slot cifrado sem chave em vez de ficar calado, mescla sem perder o que foi lançado hoje nem duplicar o que já existia, e refaz o índice para o "Histórico na Nuvem" voltar a listar. |
