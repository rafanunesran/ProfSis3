...
| `teste-lista-escola.js` | A lista da gestao voltando ao professor depois da adequacao: o gestor publica um retrato cifrado com a chave do espaco (o nome do estudante **nao** aparece nem no documento em claro nem no publicado); transferencia, matricula nova e exclusao feitas pela gestao chegam a quem adicionou a turma; professor **sem** o codigo fica com a lista parada e uma faixa explicando, em vez de com a turma apagada; e painel que abriu vazio **nao** publica lista vazia por cima da cheia. |
